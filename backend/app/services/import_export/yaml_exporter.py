"""YAML export service for ARS data."""
...
class YAMLExporter(BaseExporter):
    """YAML format exporter for ARS data."""
    
    def export_reporting_event(self, reporting_event_id: str, output_path: str) -> ExportResult:
        """Export a complete reporting event to YAML format."""
        try:
            self._update_progress(0, 100, "Starting YAML export...")
            ...
            self._update_progress(50, 100, "Writing YAML file...")
            ...
            return ExportResult(
                success=True,
                message="YAML export completed successfully",
            ...
            return ExportResult(
                success=False,
                message=f"YAML export failed: {str(e)}",
                records_exported=0,
                errors=[str(e)],
                export_time=datetime.now()
            )
    ...
    def export_analyses(self, analysis_ids: List[str], output_path: str) -> ExportResult:
        """Export specific analyses to YAML format."""
        try:
            ...
            return ExportResult(
                success=True,
                message="Analyses YAML export completed successfully",
                file_path=output_path,
            ...
            return ExportResult(
                success=False,
                message=f"Analyses YAML export failed: {str(e)}",
                records_exported=0,
                errors=[str(e)],
                export_time=datetime.now()
            )
    ...
    def export_custom_query(self, query_params: Dict[str, Any], output_path: str) -> ExportResult:
        """Export data based on custom query parameters to YAML format."""
        try:
            ...
            return ExportResult(
                success=True,
                message="Custom query YAML export completed successfully",
                file_path=output_path,
            ...
            return ExportResult(
                success=False,
                message=f"Custom query YAML export failed: {str(e)}",
                records_exported=0,
                errors=[str(e)],
                export_time=datetime.now()
            )