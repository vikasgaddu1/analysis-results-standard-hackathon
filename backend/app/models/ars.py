...
Adapted for FastAPI backend structure
"""
...
class WhereClause(Base):
    ...
    __table_args__ = (
        CheckConstraint("clause_type IN ('condition', 'compound_expression')", name='check_clause_type'),
    )
...
class WhereClauseCondition(Base):
    ...
    __table_args__ = (
        CheckConstraint("comparator IN ('EQ', 'NE', 'GT', 'LT', 'GE', 'LE', 'IN', 'NOTIN', 'CONTAINS')", 
                       name='check_comparator'),
    )
...
class WhereClauseCompoundExpression(Base):
    ...
    __table_args__ = (
        CheckConstraint("logical_operator IN ('AND', 'OR', 'NOT')", name='check_logical_operator'),
    )
